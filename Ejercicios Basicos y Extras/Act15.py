...
interes = 0.04
capital = float(input("Introduce la cantidad de dinero que quieres depositar: "))
for i in range(1, 4):
    cantidadAhorros = capital * (1 + interes)
    capital = cantidadAhorros
    print("Año", i, "tus ahorros seran: {:.2f} lereles".format(cantidadAhorros))
